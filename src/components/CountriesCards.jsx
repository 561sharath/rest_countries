...
const CountriesCards = ({ countriesData }) => {
  ...
  return (
    <div
      className={`mb-10 mr-5 shadow-2xl  rounded-lg overflow-hidden ${
    ...
    >
      <Link to={`about/${countriesData.cca3}`}>
        ...
        <h1 className="my-2 font-medium mx-3 text-[1.2rem]">
        ...
        <p className="mb-2 mx-3">
          Capital : {countriesData.capital ? countriesData.capital : "NA"}
        </p>
      </Link>
    </div>
  );
